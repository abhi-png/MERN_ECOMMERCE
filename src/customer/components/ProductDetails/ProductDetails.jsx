        ...
        <div className="bg-white lg:px-20">
            <div className="pt-6">
                ...
                <section className="grid grid-cols-1 lg:grid-cols-2 gap-x-8 gap-y-10 px-4 pt-10">
                    ...
                    <div className="lg:col-span-1 max-auto max-w-2xl px-4 pb-16 sm:px-6 lg:max-w-7xl lg:px-8 lg:pb-24">
                        <div className="lg:col-span-2">
                            <h1 className="text-lg sm:text-xl font-semibold text-gray-900">{product.brand}</h1>
                        ...
                        <div className="mt-4 lg:row-span-3 lg:mt-0">
                            ...
                            <div className="mt-6">
                                <div className="flex items-center space-x-3">
                                    ...
                                    <p className="text-sm ml-3 font-medium text-indigo-600 hover:text-indigo-500">3870 Reviews</p>
                                </div>
                            </div>
                ...
                <section className="pt-10">
                    ...
                    <div className="flex flex-wrap space-y-5 gap-2">
